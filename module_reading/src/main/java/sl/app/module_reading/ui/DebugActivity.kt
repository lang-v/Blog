...
import sl.app.module_markdown.component.*
...
////                ARouter.getInstance().build(BLOG_PAGE).withString(BLOG_PAGE_URL,"https://test.cn").navigation()
//                val intent = Intent(this@DebugActivity,BrowseActivity::class.java)
//                intent.putExtra(BLOG_PAGE_URL,"https://test.cn")
//                startActivity(intent)
//            }
//        }

//        val tableElement = TableElement(arrayOf("|test1|test2|test3|test1|test2|test3|test1|test2|test3|test1|test2|test3|test1|test2|test3|test1|test2|test3|test1|test2|test3|test1|test2|test3|test1|test2|test3|test1|test2|test3|test1|test2|test3","|---|---|---","|data1|data2|data3","s|sd|ds"))
//        findViewById<LinearLayout>(R.id.container).apply {
//            addView(TextView(this,Element("#### 我是*标题* \n ~~删除线~~ **粗体** *斜体* <u>下划线</u>`Canvas`\n> 我是引言\n1. 有序列表\n- 无序列表\n[百度一下](https://www.baidu.com)")).getView())
//            addView(TitleTextView(this, Element("我是标题")).getView())
//            addView(CommonTextView(this,Element("我是普通文本")).getView())
//            addView(ItalicTextView(this,Element("我是斜体文本")).getView())
//            addView(BoldTextView(this,Element("我是粗体文本")).getView())
//            addView(UnderscoreTextView(this,Element("我是下划线文本")).getView())
//            addView(InlineCodeTextView(this,Element("我是inlineCode")).getView())
//            addView(InlineImageView(this, ImageElement("https://img-blog.csdnimg.cn/20200327173153227.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzM2NjE3MTk4,size_16,color_FFFFFF,t_70","图片")).getView())
//            addView(CodeView(this,Element("public static void main(String[] args) {\n\t return 0;\n}")).getView())
//            addView(ImageView(this, ImageElement("https://img-blog.csdnimg.cn/20200327173153227.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzM2NjE3MTk4,size_16,color_FFFFFF,t_70","图片")).getView())
//            addView(TableView(this,tableElement).getView())
//            addView(TitleTextView(this, Element("我是标题")).getView())
//            addView(CommonTextView(this,Element("我是普通文本")).getView())
//            addView(ItalicTextView(this,Element("我是斜体文本")).getView())
//            addView(BoldTextView(this,Element("我是粗体文本")).getView())
...
//        }
        ...
        findViewById<MarkDownContainer>(R.id.markdownContainer).apply {
//            setContent(
//                """
...
//                3. Glide  源码 三级缓存
//                4. Retrofit 实现源码
//                5. 路由框架 ARouter ；接口下沉、跨模块通信
//                6. 协程运用(Flow、Scope、Job)
//                   1. dsa
//
//
//
